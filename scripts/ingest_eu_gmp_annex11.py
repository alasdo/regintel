...
DOCUMENT_SHORT_CODE = "EU_GMP_ANNEX_11"
SOURCE_TYPE = "eu_gmp_annex"
CORPUS = "eu_gmp"
TITLE = "EU GMP Annex 11: Computerised Systems"
SOURCE_URL = "https://health.ec.europa.eu/system/files/2016-11/annex11_01-2011_en_0.pdf"
...
def fetch_pdf_text() -> str:
    ...
    if not full_text:
        raise ValueError("Failed to extract text from EU GMP Annex 11 PDF.")
...
def extract_main_text(full_text: str) -> str:
    ...
    if start_idx == -1:
        # fallback: use the full cleaned text if headings are not found
