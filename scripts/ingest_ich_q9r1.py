...
DOCUMENT_SHORT_CODE = "ICH_Q9R1"
SOURCE_TYPE = "ich_guideline"
CORPUS = "ich"
TITLE = "ICH Q9(R1): Quality Risk Management"
SOURCE_URL = "https://database.ich.org/sites/default/files/ICH_Q9%28R1%29_Guideline_Step4_2022_1219.pdf"
PUBLICATION_DATE = date(2022, 1, 18)
...
def fetch_pdf_text() -> str:
    ...
    if not full_text:
        raise ValueError("Failed to extract text from ICH Q9(R1) PDF.")
...
def extract_main_text(full_text: str) -> str:
    """
    Start at the first real body heading and avoid the table of contents.
    """
    start_markers = [
        "\n1. INTRODUCTION",
        "1. INTRODUCTION",
