...
DOCUMENT_SHORT_CODE = "FDA_QUALITY_SYSTEMS"
SOURCE_TYPE = "fda_guidance"
CORPUS = "us_fda"
TITLE = "Quality Systems Approach to Pharmaceutical CGMP Regulations"
SOURCE_URL = "https://www.fda.gov/media/71023/download"
PUBLICATION_DATE = date(2006, 9, 1)
...
def fetch_pdf_text() -> str:
    ...
    if not full_text:
        raise ValueError("Failed to extract text from the FDA quality systems PDF.")
...
def extract_guidance_text(full_text: str) -> str:
    ...
    if not extracted:
        raise ValueError("Could not extract main quality systems guidance text.")
